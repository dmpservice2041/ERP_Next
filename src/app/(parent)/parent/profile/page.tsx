...
export default function ParentProfile() {
    ...
    return (
        <div>
            <Title order={2} mb="md">Parent Profile</Title>
            <Paper p="xl" withBorder radius="md">
                ...
                <Stack gap="md">
                    <Text fw={700}>Account Information</Text>
                    <Group>
                        <Text size="sm" fw={500} w={150}>Guardian ID:</Text>
                        <Text size="sm">PAR-{user.id.slice(0, 8)}</Text>
                    </Group>
                    <Group>
